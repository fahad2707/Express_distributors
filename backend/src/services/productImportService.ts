...
// QuickBooks-compatible: Product/Service Name, SKU, Sales Price/Rate, Taxable, Purchase Cost, (optional) Type, Sales Description, Quantity On Hand. No PLU, Barcode, or picture.
